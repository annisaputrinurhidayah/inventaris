...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            <form action="{{ route('inventaris.update',['inventari'=>$inventaris->id]) }}" class="card card-primary" method="POST">
                ...
                <div class="card-body">
                    ...
                    <x-select label="Ruang" name="ruang_id" :data-option="$ruang" :value="$inventaris->ruang_id"/>
